...
function App() {
  ...
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Hoover", description: "Upstairs and downstairs", deadline: "Tonight", priority:"low", done: false },
      { id: 5, title: "Wash Car", description: "Wash outside, clean inside", deadline: "Two days from now", priority:"low", done: false }
    ]
  });
